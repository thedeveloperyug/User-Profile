...
const post = () => {
    return (
            ...
            <>
                <div className=" py-2 justify-center min-h-screen">
                    <div className="rounded-xl mb-5 border shadow-md w-full bg-white">
                        <div className="flex w-full items-center px-10 justify-between border-b">
                    ...
                    <div className="rounded-xl border shadow-md w-full bg-white">
                        <div className="flex w-full items-center px-10 justify-between border-b">
                            <div className="flex items-center space-x-3">
                                <div className="h-8 w-8 rounded-full bg-slate-400 bg-[url('https://i.pravatar.cc/32')]" />
                                <div className="text-lg font-bold text-slate-700">Joe Smith</div>
